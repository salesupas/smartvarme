	...
	<section class="shipping-calculator-form" id="shipping-calculator-form">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_city_field">
				...
				<?php if ( empty( WC()->customer->get_shipping_city() ) ) : ?>
		<span style="color:#c50000;">Skriv inn by for å fortsette</span>
	<?php endif; ?>
			</p>
		<?php endif; ?>
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_postcode_field">
				...
				<?php if ( empty( WC()->customer->get_shipping_postcode() ) ) : ?>
		<span style="color:#c50000;">Skriv inn postnummer for å fortsette</span>
	<?php endif; ?>
			</p>
		<?php endif; ?>

		<p><button type="submit" name="calc_shipping" value="1" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"><?php esc_html_e( 'Calculate shipping', 'woocommerce' ); ?></button></p>
